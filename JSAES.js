...
window.AES_ExpandKey = AES_ExpandKey;
...
window.AES_SubBytes = AES_SubBytes;
  
  function AES_AddRoundKey(state, rkey) {
    for(var i = 0; i < 16; i++)
      state[i] ^= rkey[i];
  }
window.AES_AddRoundKey = AES_AddRoundKey;
...
window.AES_ShiftRows = AES_ShiftRows;
...
window.AES_MixColumns = AES_MixColumns;
...
window.AES_MixColumns_Inv = AES_MixColumns_Inv;